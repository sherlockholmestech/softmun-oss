...
const state = ref({
	timeLeft: selectedCommitteeData.value?.modSpeakingTime ?? 90,
	totalTime: selectedCommitteeData.value?.modSpeakingTime ?? 90,
	isRunning: false,
	progress: 100,
...
watch(
	() => selectedCommitteeData.value?.modSpeakingTime,
	(newTime) => {
